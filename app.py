...
st.title("📸 ระบบสแกนใบหน้าค้นหารูปถ่ายในงาน (เวอร์ชันกล้องใหญ่เสถียร 100%)")
...
if choice == "หน้าหลักสำหรับสแกนรูป":
    ...
    # 🎯 แก้ไขจุดเอ๋อเรียบร้อย: ลบตัวแปรมีปัญหาออก ทำให้ปุ่มทำงานเสถียรทั้งถ่ายรูปสดและดึงไฟล์ชัด ๆ ครับน้า
